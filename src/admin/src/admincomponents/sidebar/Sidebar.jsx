...
import './sidebar.css'; // Özel CSS dosyasını burada dahil edin
  ...
  return (
    <div className="sidebar">
      ...
      <nav className="sidebar__nav">
        <ul>
          <li><Link to="/admin"><i className='bx bx-home'></i> HOME</Link></li>
          <li><Link to="/admin/about"><i className='bx bx-user'></i> ABOUT</Link></li>
          <li><Link to="/admin/skills"><i className='bx bx-category'></i> SKILLS</Link></li>
          <li><Link to="/admin/services"><i className='bx bx-cog'></i> SERVICES</Link></li>
          <li><Link to="/admin/portfolio"><i className='bx bx-collection'></i> PORTFOLIO</Link></li>
          <li><Link to="/admin/contact"><i className='bx bx-envelope'></i> CONTACT</Link></li>
          <li><Link to="/admin/qualification"><i className='bx bx-badge-check'></i> QUALIFICATION</Link></li>
          <li><Link to="/admin/testimonials"><i className='bx bx-chat'></i> TESTIMONIALS</Link></li>
        </ul>
      </nav>
    </div>
  );
